...
I'm **Kayan Shah** - a student engineer and programmer based in London. I build software and hardware that makes a real-world impact: from Python tools and Swift apps, to **international electric cars and world championship-level robots**. Currently leading teams to and heading to the **VEX World Championships 2026**, fresh from **Greenpower International Finals 2025**.
